...
public class SecondActivity extends AppCompatActivity {
    ...
    public void onclick(){
        ...
        Toast.makeText(this,"开始扫描周围的蓝牙设备",Toast.LENGTH_SHORT).show();
        // 扫描，如果在扫描，先取消，然后再开始
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MESSAGE_WRITE:
                    ...
                    Toast.makeText(SecondActivity.this, "Me："+message, Toast.LENGTH_SHORT).show();
                    break;
                case MESSAGE_READ:
                    byte[] read = (byte[]) msg.obj;
                    String readMsg = new String(read);
                    mConversationArrayAdapter.add(mConnectedDeviceName+":"+readMsg);
                    Toast.makeText(SecondActivity.this, mConnectedDeviceName+":"+readMsg, Toast.LENGTH_SHORT).show();
                    break;
                case MESSAGE_DEVICE_NAME:
                    mConnectedDeviceName = msg.getData().getString(DEVICE_NAME);
                    Toast.makeText(SecondActivity.this, "连接到："+mConnectedDeviceName, Toast.LENGTH_SHORT).show();
                    break;
                case MESSAGE_TOAST:
                    Toast.makeText(SecondActivity.this, msg.getData().getString(TOAST), Toast.LENGTH_SHORT).show();
            }
        }
    };
}
